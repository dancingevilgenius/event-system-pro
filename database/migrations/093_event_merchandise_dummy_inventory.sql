-- Seed dummy shirt inventory into event_merchandise.merchandise_json for POS demo.
-- Run: psql -U postgres -d event_system_pro -f database/migrations/093_event_merchandise_dummy_inventory.sql

\connect event_system_pro

INSERT INTO public.event_merchandise (event_code, merchandise_json, created_by)
SELECT
  e.event_code,
  json_build_object(
    'items',
